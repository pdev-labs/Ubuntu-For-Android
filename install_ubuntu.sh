...
install_ubuntu() {
    ...
    echo "Android 12+ includes a strict 'Phantom Process Killer' that may terminate"
    echo "Termux during heavy operations, resulting in a '[Process completed (signal 9)]' error."
    ...
    echo "Please refer to the GitHub repository documentation for step-by-step instructions."
    echo "========================================="
    echo ""
